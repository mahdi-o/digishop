...
class BoxRowProduct extends StatelessWidget {
   BoxRowProduct({super.key, required this.name, required this.price, required this.image});
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      width: 110,
                      height: 35,
                      child: const Center(child: Text('جزئیات',style: TextStyle(fontFamily:'Titr',fontSize: 15),)),
                    ),
                    Obx(
                    ()=> GestureDetector(
                          onTap: (){
